...
public class AnimalController {
    ...
    @Operation(summary = "Cria registro do Animal", description = "Metodo que cria registro do Animal", tags = "Criar")
    @PostMapping
    ...
    @Operation(summary = "Lista todos", description = "Metodo que retorna todos os animais", tags = "Consultar")
    @GetMapping
    public ResponseEntity<List<AnimalModel>> getAllAnimals() {
        return new ResponseEntity<>(animalService.getAllAnimals(), HttpStatus.OK);
    }

    @Operation(summary = "Busca por ID", description = "Metodo que consulta o animal pelo ID", tags = "Consultar")
    @GetMapping("/{id}")
    public ResponseEntity<AnimalModel> getAnimalById(@PathVariable Long id) {
        return ResponseEntity.ok(animalService.getAnimalById(id));
    }

    @Operation(summary = "Busca por Nome", description = "Metodo que consulta o animal pelo Nome", tags = "Consultar")
    @GetMapping("/name")
    ...
    @Operation(summary = "Altera Status", description = "Metodo que altera o status do animal", tags = "Alterar")
    @PatchMapping("/{id}/status")
    public ResponseEntity<Animal> updateAnimalStatus(@PathVariable Long id, @RequestParam Status status) {
        return ResponseEntity.ok(animalService.updateAnimalStatus(id, status));
    }
